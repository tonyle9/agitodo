...
def build(src_dir, build_dir, UGLIFY=False):
    ...
    write_file(merge_files(*SOURCES_MERGE), "script.js", base=join_paths(build_dir, "js/"))

    if UGLIFY:
        uglifyjs(join_paths(build_dir, "js/script.js"), join_paths(build_dir, "js/script.js"), verbose=True)
